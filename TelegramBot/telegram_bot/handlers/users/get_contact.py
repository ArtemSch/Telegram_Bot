...
async def share_number(message: types.Message):
    await message.answer(
        ...
        f"Для того, чтобы наш менеджер Вам перезвонил поделитесь своим телефоном"
...
async def get_contact(message: types.Message):
    ...
    await message.answer(
        ...
        f"Ваш номер {contact.phone_number} был получен и передан менеджеру. Ожидайте звонка",
